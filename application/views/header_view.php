...
<head>
  ...
  <title><?php echo $title_web;?> | EPITYCHIA LIBRARY </title>
...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="<?php echo base_url('index.php/dashboard');?>" class="logo">
      ...
      <span class="logo-mini"><img src="logo.JPEG" height="50px" width="50px;"></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">EPITYCHIA LIBRARY</span>
    </a>
